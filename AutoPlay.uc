...
var ButtonHandle BtnPageDec;
var ButtonHandle BtnPageInc;
...
b_SkillsShow = false;
  ...
  Btnattack = ButtonHandle ( GetHandle ("AutoPlay.AutoPlayExpand.Btnattack") );
  Btnattack.SetTooltipCustomType(MakeTooltipSimpleText("Click: To Config AutoFarm"));
    ...
    botonm = ButtonHandle ( GetHandle ("AutoPlay.AutoPlayMinimized.BtnExpand") );
	botone = ButtonHandle ( GetHandle ("AutoPlay.AutoPlayExpand.BtnMinimized") );
    botonm.SetTooltipCustomType(MakeTooltipSimpleText("Expand"));
    botone.SetTooltipCustomType(MakeTooltipSimpleText("Minimized"));
	
	
    BtnRespectHunt = ButtonHandle ( GetHandle ("AutoPlay.AutoPlayExpand.BtnRespectHunt") );
	BtnRespectHunt.SetTooltipCustomType(MakeTooltipSimpleText("Click: To Activate RespectHunt"));
	BtnSummon = ButtonHandle ( GetHandle ("AutoPlay.AutoPlayExpand.BtnSummon") );
	BtnSummon.SetTooltipCustomType(MakeTooltipSimpleText("Summon Attack"));
	
	
	BtnLongRange = ButtonHandle ( GetHandle ("AutoPlay.AutoPlayExpand.BtnLongRange") );
	BtnShortRange = ButtonHandle ( GetHandle ("AutoPlay.AutoPlayExpand.BtnShortRange") );
	BtnLongRange.SetTooltipCustomType(MakeTooltipSimpleText("Click: To Inc Range Max"));
	BtnShortRange.SetTooltipCustomType(MakeTooltipSimpleText("Click: To Dec Range Max"));
	BtnBuff = ButtonHandle ( GetHandle ("AutoPlay.AutoPlayExpand.BtnBuff") );
	BtnBuff.SetTooltipCustomType(MakeTooltipSimpleText("Buff Protection"));
	
	BtnPageDec = ButtonHandle ( GetHandle ("AutoPlay.AutoPlayExpand.BtnDecPage") );
	BtnPageDec.SetTooltipCustomType(MakeTooltipSimpleText("Dec Bar Skill"));
    BtnPageInc = ButtonHandle ( GetHandle ("AutoPlay.AutoPlayExpand.BtnIncPage") );
	BtnPageInc.SetTooltipCustomType(MakeTooltipSimpleText("Inc Bar Skill"));
...
function Bypass( string strBypass)
{
...
Bypass("_autofarm");
	...
	Bypass("_radiusAutoFarm inc_radius");
		break;
		case "BtnShortRange":
		
	Bypass("_radiusAutoFarm dec_radius");
		break;
		case "BtnRespectHunt":
		
Bypass("_enableRespectHunt");
		break;
		
		
		case "BtnIncPage":
     
	Bypass("_pageAutoFarm inc_page");
		break;
				case "BtnDecPage":
        
  Bypass("_pageAutoFarm dec_page");
	...
	Bypass("_enableSummonAttack");
		break;
		case "BtnBuff":
        
  Bypass("_enableBuffProtect");
