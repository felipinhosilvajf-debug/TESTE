...
import l2f.gameserver.economy.EconomyManager;
...
public class PcInventory extends Inventory
{
	...
	public ItemInstance addAdena(long amount, String log)
	{
		...
		final long balanceBefore = getAdena();

		final ItemInstance result =
			addItem(
				ItemTemplate.ITEM_ID_ADENA,
				amount,
				log
			);
		...
		if (result != null)
		{
			final long balanceAfter = getAdena();

			EconomyManager.getInstance().recordAdenaTransaction(
				_owner,
				"ADD",
				amount,
				balanceBefore,
