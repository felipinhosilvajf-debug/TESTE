...
VERIFY_CLASS_SIZE_NODIE(UActionAPI)
VERIFY_CLASS_SIZE_NODIE(UAnimTextureHandle)
VERIFY_CLASS_SIZE_NODIE(UTextureHandle)
VERIFY_CLASS_SIZE_NODIE(UAuctionAPI)
VERIFY_CLASS_SIZE_NODIE(UAudioAPI)
VERIFY_CLASS_SIZE_NODIE(UBarHandle)
VERIFY_CLASS_SIZE_NODIE(UWindowHandle)
VERIFY_CLASS_SIZE_NODIE(UBookMarkAPI)
VERIFY_CLASS_SIZE_NODIE(UUIEventManager)
VERIFY_CLASS_SIZE_NODIE(UButtonHandle)
VERIFY_CLASS_SIZE_NODIE(UCharacterViewportWindowHandle)
VERIFY_CLASS_SIZE_NODIE(UChatWindowHandle)
VERIFY_CLASS_SIZE_NODIE(UTextListBoxHandle)
VERIFY_CLASS_SIZE_NODIE(UCheckBoxHandle)
VERIFY_CLASS_SIZE_NODIE(UComboBoxHandle)
VERIFY_CLASS_SIZE_NODIE(UCommandChannelAPI)
VERIFY_CLASS_SIZE_NODIE(UDrawPanelHandle)
VERIFY_CLASS_SIZE_NODIE(UEditBoxHandle)
VERIFY_CLASS_SIZE_NODIE(UEnchantAPI)
VERIFY_CLASS_SIZE_NODIE(UEventMatchAPI)
VERIFY_CLASS_SIZE_NODIE(UFileListAPI)
VERIFY_CLASS_SIZE_NODIE(UFlashCtrlHandle)
VERIFY_CLASS_SIZE_NODIE(UGFxUIScript)
VERIFY_CLASS_SIZE_NODIE(UUIScript)
VERIFY_CLASS_SIZE_NODIE(UGMAPI)
VERIFY_CLASS_SIZE_NODIE(UGraphicAPI)
VERIFY_CLASS_SIZE_NODIE(UHennaAPI)
VERIFY_CLASS_SIZE_NODIE(UHeroTowerAPI)
VERIFY_CLASS_SIZE_NODIE(UHtmlHandle)
VERIFY_CLASS_SIZE_NODIE(UInputAPI)
VERIFY_CLASS_SIZE_NODIE(UItemWindowHandle)
VERIFY_CLASS_SIZE_NODIE(UListBoxHandle)
VERIFY_CLASS_SIZE_NODIE(UListCtrlHandle)
VERIFY_CLASS_SIZE_NODIE(UMacroAPI)
VERIFY_CLASS_SIZE_NODIE(UMiniMapAPI)
VERIFY_CLASS_SIZE_NODIE(UMinimapCtrlHandle)
VERIFY_CLASS_SIZE_NODIE(UMultiEditBoxHandle)
VERIFY_CLASS_SIZE_NODIE(UNameCtrlHandle)
VERIFY_CLASS_SIZE_NODIE(UOlympiadAPI)
VERIFY_CLASS_SIZE_NODIE(UPartyMatchAPI)
VERIFY_CLASS_SIZE_NODIE(UPetAPI)
VERIFY_CLASS_SIZE_NODIE(UPetitionAPI)
VERIFY_CLASS_SIZE_NODIE(UPostWndAPI)
VERIFY_CLASS_SIZE_NODIE(UProgressCtrlHandle)
VERIFY_CLASS_SIZE_NODIE(UPropertyControllerHandle)
VERIFY_CLASS_SIZE_NODIE(UQuestAPI)
VERIFY_CLASS_SIZE_NODIE(URadarMapCtrlHandle)
VERIFY_CLASS_SIZE_NODIE(URadioButtonHandle)
VERIFY_CLASS_SIZE_NODIE(URecipeAPI)
VERIFY_CLASS_SIZE_NODIE(URefineryAPI)
VERIFY_CLASS_SIZE_NODIE(USceneCameraCtrlHandle)
VERIFY_CLASS_SIZE_NODIE(USceneEditorAPI)
VERIFY_CLASS_SIZE_NODIE(USceneMusicCtrlHandle)
VERIFY_CLASS_SIZE_NODIE(USceneNpcCtrlHandle)
VERIFY_CLASS_SIZE_NODIE(UScenePcCtrlHandle)
VERIFY_CLASS_SIZE_NODIE(USceneScreenCtrlHandle)
VERIFY_CLASS_SIZE_NODIE(UShortcutAPI)
VERIFY_CLASS_SIZE_NODIE(USiegeAPI)
VERIFY_CLASS_SIZE_NODIE(USliderCtrlHandle)
VERIFY_CLASS_SIZE_NODIE(USSAOAPI)
VERIFY_CLASS_SIZE_NODIE(USSQAPI)
VERIFY_CLASS_SIZE_NODIE(UStatusBarHandle)
VERIFY_CLASS_SIZE_NODIE(UStatusIconHandle)
VERIFY_CLASS_SIZE_NODIE(UTabHandle)
VERIFY_CLASS_SIZE_NODIE(UTeamMatchAPI)
VERIFY_CLASS_SIZE_NODIE(UTextBoxHandle)
VERIFY_CLASS_SIZE_NODIE(UTreeHandle)
VERIFY_CLASS_SIZE_NODIE(UTutorialAPI)
VERIFY_CLASS_SIZE_NODIE(UUIAPI_BUTTON)
VERIFY_CLASS_SIZE_NODIE(UUIAPI_WINDOW)
VERIFY_CLASS_SIZE_NODIE(UUIAPI_CHECKBOX)
VERIFY_CLASS_SIZE_NODIE(UUIAPI_COMBOBOX)
VERIFY_CLASS_SIZE_NODIE(UUIAPI_EDITBOX)
VERIFY_CLASS_SIZE_NODIE(UUIAPI_EFFECTBUTTON)
VERIFY_CLASS_SIZE_NODIE(UUIAPI_INVENWEIGHT)
VERIFY_CLASS_SIZE_NODIE(UUIAPI_ITEMWINDOW)
VERIFY_CLASS_SIZE_NODIE(UUIAPI_LISTCTRL)
VERIFY_CLASS_SIZE_NODIE(UUIAPI_MINIMAPCTRL)
VERIFY_CLASS_SIZE_NODIE(UUIAPI_MULTIEDITBOX)
VERIFY_CLASS_SIZE_NODIE(UUIAPI_MULTISELLITEMINFO)
VERIFY_CLASS_SIZE_NODIE(UUIAPI_MULTISELLNEEDEDITEM)
VERIFY_CLASS_SIZE_NODIE(UUIAPI_SHORTCUTITEMWINDOW)
VERIFY_CLASS_SIZE_NODIE(UUIAPI_SLIDERCTRL)
VERIFY_CLASS_SIZE_NODIE(UUIAPI_STATUSBARCTRL)
VERIFY_CLASS_SIZE_NODIE(UUIAPI_STATUSICONCTRL)
VERIFY_CLASS_SIZE_NODIE(UUIAPI_TEXTBOX)
VERIFY_CLASS_SIZE_NODIE(UUIAPI_TEXTLISTBOX)
VERIFY_CLASS_SIZE_NODIE(UUIAPI_TEXTURECTRL)
VERIFY_CLASS_SIZE_NODIE(UUIAPI_TREECTRL)
VERIFY_CLASS_SIZE_NODIE(UUIDataManager)
VERIFY_CLASS_SIZE_NODIE(UUIDATA_CLAN)
VERIFY_CLASS_SIZE_NODIE(UUIDATA_GAMETIP)
VERIFY_CLASS_SIZE_NODIE(UUIDATA_HENNA)
VERIFY_CLASS_SIZE_NODIE(UUIDATA_HUNTINGZONE)
VERIFY_CLASS_SIZE_NODIE(UUIDATA_ITEM)
VERIFY_CLASS_SIZE_NODIE(UUIDATA_MACRO)
VERIFY_CLASS_SIZE_NODIE(UUIDATA_NPC)
VERIFY_CLASS_SIZE_NODIE(UUIDATA_PARTY)
VERIFY_CLASS_SIZE_NODIE(UUIDATA_PAWNVIEWER)
VERIFY_CLASS_SIZE_NODIE(UUIDATA_PET)
VERIFY_CLASS_SIZE_NODIE(UUIDATA_PLAYER)
VERIFY_CLASS_SIZE_NODIE(UUIDATA_QUEST)
VERIFY_CLASS_SIZE_NODIE(UUIDATA_RAID)
VERIFY_CLASS_SIZE_NODIE(UUIDATA_RECIPE)
VERIFY_CLASS_SIZE_NODIE(UUIDATA_REFINERYOPTION)
VERIFY_CLASS_SIZE_NODIE(UUIDATA_SKILL)
VERIFY_CLASS_SIZE_NODIE(UUIDATA_STATICOBJECT)
VERIFY_CLASS_SIZE_NODIE(UUIDATA_TARGET)
VERIFY_CLASS_SIZE_NODIE(UUIDATA_TRANSFORM)
VERIFY_CLASS_SIZE_NODIE(UUIDATA_TUTORIALLIST)
VERIFY_CLASS_SIZE_NODIE(UUIDATA_USER)
VERIFY_CLASS_SIZE_NODIE(UVehicleAPI)
VERIFY_CLASS_SIZE_NODIE(UVideoPlayerCtrlHandle)
