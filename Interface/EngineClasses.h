...
AUTOGENERATE_NAME(OnStart)
AUTOGENERATE_NAME(OnStop)
AUTOGENERATE_NAME(OnBoost)
AUTOGENERATE_NAME(OnMoveUp)
AUTOGENERATE_NAME(OnMoveDown)
AUTOGENERATE_NAME(OnTurning)
AUTOGENERATE_NAME(OnDriverIn)
AUTOGENERATE_NAME(OnDriverOut)
...
struct ENGINE_API FDecorationLayer
{
    ...
    INT AlignToTerrain;
    BYTE DrawOrder;
    INT ShowOnInvisibleTerrain GCC_PACK(4);
    INT LitDirectional;
...
public:
    ...
    BYTE L2LodViewType;
    FLOAT L2LodViewDuration GCC_PACK(4);
    ...
    BYTE AttachType;
    class ALevelInfo* Level GCC_PACK(4);
    class ULevel* XLevel;
    FLOAT LifeSpan;
    FPointRegion Region;
    ...
    FLOAT TimerRate;
    class UMesh* Mesh;
    class UMeshContainer* MeshContainer;
    BITFIELD bReadyToRender:1 GCC_PACK(4);
    ...
    FName L2MoveEvent;
    BYTE TargetSpineStatus;
    FLOAT LODBias GCC_PACK(4);
    FName InitialState;
    FName Group;
    ...
    BYTE NAttackStatus;
    class AActor* EffectOwner GCC_PACK(4);
    BYTE SpawnPos;
    FTextureModifyinfo TexModifyInfo GCC_PACK(4);
    ...
    DECLARE_FUNCTION(execPlayLoopSound);
...
public:
    ...
    void eventSceneStarted(class ALevelInfo* Info)
    {
...
{
public:
    BITFIELD UseDefaultMap:1 GCC_PACK(4);
...
public:
    ...
    INT MapY;
    FVector AffectBox;
    BITFIELD bUseAffectBox:1 GCC_PACK(4);
    BITFIELD bLoaded:1;
...
public:
    ...
    BYTE MoveType;
    TArrayNoInit<FVector> DeltaPoint GCC_PACK(4);
    ...
    NO_DEFAULT_CONSTRUCTOR(ASuperPointInfo)
};
...
struct ENGINE_API FRandomAnimName
{
    FName CastShortAnimNameA[11];
    FName CastMidAnimNameA[11];
    FName CastLongAnimNameA[11];
    FName CastEndAnimNameA[11];
    FName MagicNoTargetAnimNameA[11];
    FName MagicShotAnimNameA[11];
    FName MagicThrowAnimNameA[11];
};
...
public:
    ...
    class AActor* FishLine GCC_PACK(4);
    ...
    FName TurnAnimName[11];
    FName WalkAnimName[11];
    FName RunAnimName[11];
    FName FallAnimName[11];
    FName DamageFlyAnimName[11];
    FName JumpAnimName[11];
    FName BJumpAnimName[11];
    FName WaitAnimName[11];
    FName AtkWaitAnimName[11];
    FName SitAnimName[11];
    FName SitWaitAnimName[11];
    FName StandAnimName[11];
    FName DeathStandAnimName[11];
    FName ChairSitAnimName[11];
    FName ChairWaitAnimName[11];
    FName ChairStandAnimName[11];
    FName StunAnimName[11];
    FName Atk01AnimName[11];
    FName Atk02AnimName[11];
    FName Atk03AnimName[11];
    FName AtkUpAnimName[11];
    FName AtkDownAnimName[11];
    FName SpAtk01AnimName[11];
    FName SpAtk02AnimName[11];
    FName SpAtk03AnimName[11];
    FName SpAtk04AnimName[11];
    FName SpAtk05AnimName[11];
    FName SpAtk06AnimName[11];
    FName SpAtk07AnimName[11];
    FName SpAtk08AnimName[11];
    FName SpAtk09AnimName[11];
    FName SpAtk10AnimName[11];
    FName SpAtk11AnimName[11];
    FName SpAtk12AnimName[11];
    FName SpAtk13AnimName[11];
    FName SpAtk14AnimName[11];
    FName SpAtk15AnimName[11];
    FName SpAtk16AnimName[11];
    FName SpAtk17AnimName[11];
    FName SpAtk18AnimName[11];
    FName SpAtk19AnimName[11];
    FName SpAtk20AnimName[11];
    FName SpAtk21AnimName[11];
    FName SpAtk22AnimName[11];
    FName SpAtk23AnimName[11];
    FName SpAtk24AnimName[11];
    FName SpAtk25AnimName[11];
    FName SpAtk26AnimName[11];
    FName SpAtk27AnimName[11];
    FName SpAtk28AnimName[11];
    FName ShieldAtkAnimName[11];
    FName DefenceAnimName[11];
    FName DodgeAnimName[11];
    FName DeathAnimName[11];
    FName DeathWaitAnimName[11];
    FName SitDeathAnimName[11];
    FName SitDeathWaitAnimName[11];
    FName DamageAnimName[11];
    FName CastShortAnimName[11];
    FName CastMidAnimName[11];
    FName CastLongAnimName[11];
    FName CastEndAnimName[11];
    FName MagicThrowAnimName[11];
    FName MagicShotAnimName[11];
    FName MagicNoTargetAnimName[11];
    FName MagicFriendAnimName[11];
    FName PicItemAnimName[11];
    FName ThrowAnimName[11];
    FName PcSocialAnimName[20];
    FName NpcSocialAnimName[10];
    FName RiderWaitAnimName[11];
    FName RiderAtkAnimName[11];
    FName RiderRunAnimName[11];
    FName RiderDeathWaitAnimName[11];
    FName RiderDeathAnimName[11];
    FName SwimDeathAnimName[11];
    FName SwimAnimName[11];
    FName SwimWaitAnimName[11];
    FName SwimDeathWaitAnimName[11];
    FName SwimAttackWaitAnimName[11];
    FName FishStartAnimName;
    FName FishWaitAnimName;
    FName FishControlAnimName;
    FName FishPullAnimName;
    FName FishEndAnimName;
    FName CastShort2AnimName[11];
    FName CastMid2AnimName[11];
    FName CastLong2AnimName[11];
    FName CastEnd2AnimName[11];
    FName SocialCannonAnimName;
    FName SocialOperateAnimName;
    FName RiseAnimName;
    FName GlideAnimName;
    FName ShieldWaitAnimName;
    FName SpecialSocial1AnimName;
    FName SpecialSocial2AnimName;
    FName SpecialSocial3AnimName;
    FName DashWaitAnimName;
    FName DashAnimName;
    FName DashImpactAnimName;
    FRandomAnimName RandomAnim;
    FLOAT WalkAnimRate[11];
    FLOAT RunAnimRate[11];
    FLOAT Atk01AnimRate[11];
    FLOAT Atk02AnimRate[11];
    FLOAT Atk03AnimRate[11];
    FLOAT AtkUpAnimRate[11];
    FLOAT AtkDownAnimRate[11];
    FLOAT SpAtk01AnimRate[11];
    FLOAT SpAtk02AnimRate[11];
    FLOAT SpAtk03AnimRate[11];
    FLOAT SpAtk04AnimRate[11];
    FLOAT ShieldAtkAnimRate[11];
    FLOAT CastShortAnimRate[11];
    FLOAT CastMidAnimRate[11];
    FLOAT CastLongAnimRate[11];
    FLOAT CastShortEndAnimRate[11];
    FLOAT MagicThrowAnimRate[11];
    FLOAT MagicShotAnimRate[11];
    FLOAT MagicNoTargetAnimRate[11];
    FLOAT MagicFriendAnimRate[11];
    FLOAT ThrowAnimRate[11];
    FLOAT SitAnimRate;
    FLOAT StandAnimRate;
    INT PcSocialHideRightWeapon[20];
    INT PcSocialHideLeftWeapon[20];
    INT NpcSocialHideRightWeapon[10];
    INT NpcSocialHideLeftWeapon[10];
    ...
    TArrayNoInit<class AEmitter*> BoneAttachedEffects;
    class AEmitter* NQuestMarkEffect;
    TArrayNoInit<FNAbnormalStatPtr> BR_NAbnormalStat;
    BITFIELD br_bChangedWeaponEffect:1 GCC_PACK(4);
    BYTE SamePoseStat GCC_PACK(4);
    class UClass* BloodEffect GCC_PACK(4);
...
struct AVehicle_eventOnDriverOut_Parms
{
};
struct AVehicle_eventOnDriverIn_Parms
{
    INT a_DriverID;
};
struct AVehicle_eventOnTurning_Parms
{
};
struct AVehicle_eventOnMoveDown_Parms
{
};
struct AVehicle_eventOnMoveUp_Parms
{
};
struct AVehicle_eventOnBoost_Parms
{
};
struct AVehicle_eventOnStop_Parms
{
};
struct AVehicle_eventOnStart_Parms
{
};
class ENGINE_API AVehicle : public APawn
{
public:
    TArrayNoInit<FVehiclePartInfo> VehiclePartList;
    BYTE Type;
    class APawn* DriverPawn GCC_PACK(4);
    INT DriverID;
    TArrayNoInit<INT> PassengerIDList;
    INT MaxHP;
    INT CurHP;
    INT MaxFuel;
    INT CurFuel;
    FVector DriverRelLoc;
    BITFIELD bAutoCalcDriverLoc:1 GCC_PACK(4);
    BITFIELD bStart:1;
    BITFIELD bBoost:1;
    BITFIELD bMoveUp:1;
    BITFIELD bMoveDown:1;
    BITFIELD bTurning:1;
    FLOAT OldAltitude GCC_PACK(4);
    INT BoostCurTickCount;
    INT BoostTickCount;
    INT MoveUpCurTickCount;
    INT MoveUpTickCount;
    INT MoveDownCurTickCount;
    INT MoveDownTickCount;
    INT TurningCurTickCount;
    INT TurningTickCount;
    BITFIELD bTrip:1 GCC_PACK(4);
    FVector TripTarget GCC_PACK(4);
    FLOAT MoveSpeed;
    INT RotationSpeed;
    class USound* SpawnSound;
    class USound* BasicSound;
    class USound* MoveUpSound;
    class USound* MoveDownSound;
    class USound* TurnSound;
    TArrayNoInit<class USound*> RandomSounds;
    BITFIELD bRandomSound:1 GCC_PACK(4);
    FLOAT RandomTime GCC_PACK(4);
    INT RandomPercent;
    FLOAT RandomTick;
    FLOAT WaveTotalTime;
    ...
    FLOAT WaveMaxHeight;
    FLOAT WaveOldHeight;
    BITFIELD bWaveOn:1 GCC_PACK(4);
    FLOAT DriverElasticCameraDist GCC_PACK(4);
    FLOAT DriverElasticCameraVelocity;
    void eventOnDriverOut()
    {
        ProcessEvent(FindFunctionChecked(ENGINE_OnDriverOut),NULL);
    }
    void eventOnDriverIn(INT a_DriverID)
    {
        AVehicle_eventOnDriverIn_Parms Parms;
        Parms.a_DriverID=a_DriverID;
        ProcessEvent(FindFunctionChecked(ENGINE_OnDriverIn),&Parms);
    }
    void eventOnTurning()
    {
        ProcessEvent(FindFunctionChecked(ENGINE_OnTurning),NULL);
    }
    void eventOnMoveDown()
    {
        ProcessEvent(FindFunctionChecked(ENGINE_OnMoveDown),NULL);
    }
    void eventOnMoveUp()
    {
        ProcessEvent(FindFunctionChecked(ENGINE_OnMoveUp),NULL);
    }
    void eventOnBoost()
    {
        ProcessEvent(FindFunctionChecked(ENGINE_OnBoost),NULL);
    }
    void eventOnStop()
    {
        ProcessEvent(FindFunctionChecked(ENGINE_OnStop),NULL);
    }
    void eventOnStart()
    {
        ProcessEvent(FindFunctionChecked(ENGINE_OnStart),NULL);
    }
...
public:
    ...
    NO_DEFAULT_CONSTRUCTOR(AVehicleRoutePoint)
};
...
class ENGINE_API AAirShip : public APawn
{
public:
    class APawn* DriverPawn;
    DECLARE_CLASS(AAirShip,APawn,0|CLASS_Config,Engine)
    NO_DEFAULT_CONSTRUCTOR(AAirShip)
};
...
public:
    ...
    BYTE AttachedBone;
    BYTE MovementType;
    FVector DestLocation GCC_PACK(4);
...
struct AShuttle_eventOnOpen_Parms
{
};
struct AShuttle_eventOnClose_Parms
{
};
class ENGINE_API AShuttle : public APawn
{
public:
    TArrayNoInit<class AShuttleWall*> WallList;
    TArrayNoInit<class AShuttleDoor*> DoorList;
    TArrayNoInit<FString> DoorMeshNameList;
    void eventOnOpen()
    {
        ProcessEvent(FindFunctionChecked(ENGINE_OnOpen),NULL);
    }
    void eventOnClose()
    {
        ProcessEvent(FindFunctionChecked(ENGINE_OnClose),NULL);
    }
    DECLARE_CLASS(AShuttle,APawn,0|CLASS_Config,Engine)
    NO_DEFAULT_CONSTRUCTOR(AShuttle)
};
...
class ENGINE_API AShuttleDoor : public APawn
{
public:
    FLOAT OpenTime;
    FLOAT CloseTime;
    FLOAT RemainTime;
    BYTE mDoorState;
    class AShuttle* OwnerShuttle GCC_PACK(4);
    FVector relOpenLocation;
    FVector relCloseLocation;
    FVector relSafeLocation;
    DECLARE_FUNCTION(execClose);
    DECLARE_FUNCTION(execOpen);
    DECLARE_CLASS(AShuttleDoor,APawn,0|CLASS_Config,Engine)
    NO_DEFAULT_CONSTRUCTOR(AShuttleDoor)
};


struct AVehicleMeshPart_eventOnTurning_Parms
{
};
struct AVehicleMeshPart_eventOnMoveDown_Parms
{
};
struct AVehicleMeshPart_eventOnMoveUp_Parms
{
};
struct AVehicleMeshPart_eventOnBoost_Parms
{
};
struct AVehicleMeshPart_eventOnStop_Parms
{
};
struct AVehicleMeshPart_eventOnStart_Parms
{
};
struct AVehicleMeshPart_eventOnDriverOut_Parms
{
};
struct AVehicleMeshPart_eventOnDriverIn_Parms
{
    INT a_DriverID;
};
class ENGINE_API AVehicleMeshPart : public APawn
{
public:
    class USound* SpawnSound;
    class USound* BasicSound;
    ...
    void eventOnDriverIn(INT a_DriverID)
    {
        AVehicleMeshPart_eventOnDriverIn_Parms Parms;
        Parms.a_DriverID=a_DriverID;
        ProcessEvent(FindFunctionChecked(ENGINE_OnDriverIn),&Parms);
    }
    DECLARE_CLASS(AVehicleMeshPart,APawn,0|CLASS_Config,Engine)
    NO_DEFAULT_CONSTRUCTOR(AVehicleMeshPart)
};
...
public:
    ...
    BITFIELD bTargetable:1 GCC_PACK(4);
    TArrayNoInit<class UStaticMesh*> StateStaticMeshs GCC_PACK(4);
    ...
    TArrayNoInit<INT> ZoneRenderState GCC_PACK(4);
...
class ENGINE_API AShuttleWall : public AStaticMeshActor
{
public:
    class AShuttle* pShuttle;
    BITFIELD btreatAsBlock:1 GCC_PACK(4);
    DECLARE_CLASS(AShuttleWall,AStaticMeshActor,0,Engine)
    NO_DEFAULT_CONSTRUCTOR(AShuttleWall)
};
...
struct AVehicleServerPart_eventOnTurning_Parms
{
};
struct AVehicleServerPart_eventOnMoveDown_Parms
{
};
struct AVehicleServerPart_eventOnMoveUp_Parms
{
};
struct AVehicleServerPart_eventOnBoost_Parms
{
};
struct AVehicleServerPart_eventOnStop_Parms
{
};
struct AVehicleServerPart_eventOnStart_Parms
{
};
struct AVehicleServerPart_eventOnDriverOut_Parms
{
};
struct AVehicleServerPart_eventOnDriverIn_Parms
{
    INT a_DriverID;
};
class ENGINE_API AVehicleServerPart : public AStaticMeshActor
{
public:
    class USound* SpawnSound;
    class USound* BasicSound;
    ...
    void eventOnDriverIn(INT a_DriverID)
    {
        AVehicleServerPart_eventOnDriverIn_Parms Parms;
        Parms.a_DriverID=a_DriverID;
        ProcessEvent(FindFunctionChecked(ENGINE_OnDriverIn),&Parms);
    }
    DECLARE_CLASS(AVehicleServerPart,AStaticMeshActor,0,Engine)
    NO_DEFAULT_CONSTRUCTOR(AVehicleServerPart)
};
...
public:
    ...
    BITFIELD bIsSkillEffectEmitter:1 GCC_PACK(4);
    BITFIELD bUpdate:1;
    BITFIELD bAllDead:1;
...
class ENGINE_API AServerBlockingVolume : public AVolume
{
public:
    DECLARE_CLASS(AServerBlockingVolume,AVolume,0|CLASS_NativeReplication,Engine)
    NO_DEFAULT_CONSTRUCTOR(AServerBlockingVolume)
};
...
struct AVehiclePart_eventOnTurning_Parms
{
};
struct AVehiclePart_eventOnMoveDown_Parms
{
};
struct AVehiclePart_eventOnMoveUp_Parms
{
};
struct AVehiclePart_eventOnBoost_Parms
{
};
struct AVehiclePart_eventOnStop_Parms
{
};
struct AVehiclePart_eventOnStart_Parms
{
};
struct AVehiclePart_eventOnDriverOut_Parms
{
};
struct AVehiclePart_eventOnDriverIn_Parms
{
    INT a_DriverID;
};
...
public:
    ...
    void eventOnDriverIn(INT a_DriverID)
    {
        AVehiclePart_eventOnDriverIn_Parms Parms;
        Parms.a_DriverID=a_DriverID;
        ProcessEvent(FindFunctionChecked(ENGINE_OnDriverIn),&Parms);
    }
...
public:
    ...
    INT FixedDefaultCameraYaw[12];
    INT FixedDefaultCameraPitch[12];
    FLOAT FixedDefaultCameraDist[12];
    FLOAT FixedDefaultCameraViewHeight[12];
    INT FixedDefaultCameraHidePlayer[12];
    INT FixedDefaultCameraDisableZoom[12];
    INT FixedDefaultCameraExteriorView[12];
    INT FixedDefaultCameraMinDist[12];
    INT FixedDefaultCameraMaxDist[12];
    INT FixedDefaultCameraDisablePitch[12];
    ...
    BITFIELD bCameraManuallyZoomed:1;
    BITFIELD bFixView:1;
    ...
    FLOAT KeyboardLeftTurnInputDelta;
    FLOAT KeyboardRightTurnInputDelta;
    FLOAT MaxZoomingDist;
    FLOAT MinZoomingDist;
    BYTE NpcZoomCamMode;
    TArrayNoInit<FNViewShakePtr> NViewShake GCC_PACK(4);
    ...
    BYTE eCameraLocType;
    FRotator FixedRotation GCC_PACK(4);
    INT CalcBoneIndex;
...
enum ESkyRenderShape
{
    SRS_CIRCLE              =0,
    SRS_RECTANGLE           =1,
    SRS_MAX                 =2,
};
struct ENGINE_API FSkyParameter
{
    BITFIELD bUseCloudColor:1 GCC_PACK(4);
    FColor CloudColor GCC_PACK(4);
    BITFIELD bUseHazeRingcolor:1 GCC_PACK(4);
    FColor HazeRingColor GCC_PACK(4);
    BITFIELD bUseBackgroundcolor:1 GCC_PACK(4);
    FColor Backgroundcolor GCC_PACK(4);
    FLOAT ZScale;
};


class ENGINE_API ASkyRenderInfo : public AActor
{
public:
    FSkyParameter paramater;
    BYTE SkyRenderShape;
    INT EffectDistanceX GCC_PACK(4);
    INT EffectDistanceY;
    INT GradiationDistanceY;
    INT GradiationDistanceX;
    INT EffectRadius;
    INT GradiationRadius;
    DECLARE_CLASS(ASkyRenderInfo,AActor,0,Engine)
    NO_DEFAULT_CONSTRUCTOR(ASkyRenderInfo)
};
...
{
    COLORMASK_AlphaBlend    =0,
    COLORMASK_Add           =1,
    COLORMASK_MAX           =2,
};

class ENGINE_API UColorMask : public URealtimeGenerationTexture
{
public:
    BYTE ColorMaskBlend;
    class UTexture* OrgTexture GCC_PACK(4);
    class UMaskTexture* MaskTexture;
    FColor ModifierColor;
    DECLARE_CLASS(UColorMask,URealtimeGenerationTexture,0,Engine)
    NO_DEFAULT_CONSTRUCTOR(UColorMask)
};


class ENGINE_API UColorWheel : public UTexture
{
public:
    INT Radius;
    DECLARE_CLASS(UColorWheel,UTexture,0,Engine)
    NO_DEFAULT_CONSTRUCTOR(UColorWheel)
};
...
public:
    ...
    class UMaterial* NormalMap GCC_PACK(4);
...
class ENGINE_API UComplementModifier : public UModifier
{
public:
    BITFIELD ColorComplement:1 GCC_PACK(4);
    BITFIELD AlphaComplement:1;
    DECLARE_CLASS(UComplementModifier,UModifier,0,Engine)
    NO_DEFAULT_CONSTRUCTOR(UComplementModifier)
};
...
public:
    ...
    NO_DEFAULT_CONSTRUCTOR(UAnimNotify_AttackItem)
};
...
public:
    ...
    NO_DEFAULT_CONSTRUCTOR(UAnimNotify_AttackPreShot)
};
...
public:
    ...
    NO_DEFAULT_CONSTRUCTOR(UAnimNotify_AttackShot)
};
...
public:
    ...
    NO_DEFAULT_CONSTRUCTOR(UAnimNotify_AttackVoice)
};
...
public:
    ...
    NO_DEFAULT_CONSTRUCTOR(UAnimNotify_BoneScale)
};
...
public:
    ...
    NO_DEFAULT_CONSTRUCTOR(UAnimNotify_Channeling)
};
...
public:
    ...
    NO_DEFAULT_CONSTRUCTOR(UAnimNotify_IdleSound)
};
...
public:
    ...
    NO_DEFAULT_CONSTRUCTOR(UAnimNotify_ScreenFade)
};
...
public:
    ...
    NO_DEFAULT_CONSTRUCTOR(UAnimNotify_SwimSound)
};
...
public:
    ...
    NO_DEFAULT_CONSTRUCTOR(UAnimNotify_ViewShake)
};
...
public:
    ...
    BYTE SoundVolume;
    BYTE SoundPitch;
    TArrayNoInit<INT> ZonePlayState GCC_PACK(4);
...
public:
    BYTE AttachOn;
    FName AttachBoneName GCC_PACK(4);
    ...
    FVector offset;
    BITFIELD bAdjustLifeTime:1 GCC_PACK(4);
    BITFIELD bRibbonSet:1;
    BITFIELD bChanneling:1;
    FLOAT ScaleSize GCC_PACK(4);
    FLOAT SpawnDelay;
    class UClass* EffectClass;
    BITFIELD bShotAndDrain:1 GCC_PACK(4);
    BITFIELD bPawnLight:1;
    ...
    BYTE EtcEffect;
    BYTE EtcEffectInfo;
    FLOAT BR_ForceLifeTime GCC_PACK(4);
    FName BR_Tag;
...
public:
    ...
    TArrayNoInit<FNTimeColor> SkyBSPAmbient;
    TArrayNoInit<FNTimeScale> SunScale;
    TArrayNoInit<FNTimeScale> MoonScale;
    TArrayNoInit<FNTimeScale> BeastLightMap1Scale;
    TArrayNoInit<FNTimeScale> BeastLightMap2Scale;
    TArrayNoInit<FNTimeScale> GodRaySizeScale;
    TArrayNoInit<FNTimeScale> GodRayBrightnessScale;
    TArrayNoInit<FNTimeScale> GodRayEmitScale;
    INT EnvType;
...
class ENGINE_API UL2SceneInfo : public UObject
{
public:
    INT SceneID;
    FStringNoInit SceneDesc;
    TArrayNoInit<class UL2SceneItem*> SceneInfo;
    BITFIELD ForceToPlay:1 GCC_PACK(4);
    DECLARE_CLASS(UL2SceneInfo,UObject,0,Engine)
    NO_DEFAULT_CONSTRUCTOR(UL2SceneInfo)
};
...
struct ENGINE_API FScreenItem
{
    BYTE ScreenType;
    FLOAT FadeOutDuration GCC_PACK(4);
    FLOAT FadeInDuration;
    FLOAT BlackOutDuration;
    FColor FadeColor;
    INT WindowType;
    ...
    INT BackgroundType;
    INT MsgNo;
    FStringNoInit MsgText;
    INT SlideDirection;
    INT SlidingTime;
    FStringNoInit SlideTexName;
    INT SlideTexUSize;
    INT SlideTexVSize;
    INT SlideMoveRatio;
    INT SlideWndRatio;
...
struct ENGINE_API FNpcItem
{
    FStringNoInit Description;
    BYTE NpcItemType;
    INT NpcID GCC_PACK(4);
    INT Index;
    INT TargetIndex;
    FVector Location;
    INT Yaw;
    ...
    BITFIELD IsFly:1 GCC_PACK(4);
    BITFIELD IsRun:1;
    BITFIELD IsLoop:1;
    BITFIELD ImmInsight:1;
};

struct ENGINE_API FCameraItem
{
    BYTE UseCamera;
    INT TargetIndex GCC_PACK(4);
    INT dist;
    INT Yaw;
    INT Pitch;
    INT Time;
    ...
    INT RelPitch;
    INT RelRoll;
    BITFIELD IsWide:1 GCC_PACK(4);
    BITFIELD IsRelAngle:1;
    BITFIELD IsImmTarget:1;
    FLOAT CameraFov GCC_PACK(4);
};

struct ENGINE_API FMusicItem
{
    BITFIELD UseMusic:1 GCC_PACK(4);
    FStringNoInit MusicName GCC_PACK(4);
    BITFIELD StopMapMusic:1 GCC_PACK(4);
    BITFIELD StopMapAmbient:1;
    INT FadeInTime GCC_PACK(4);
    INT FadeOutTime;
    BITFIELD IsSound:1 GCC_PACK(4);
    BITFIELD IsVoice:1;
};

struct ENGINE_API FPcItem
{
    FStringNoInit Description;
    BYTE PcItemType;
    ...
    INT SetItemType;
    INT ItemSlot[29];
    BITFIELD IsRun:1 GCC_PACK(4);
    BITFIELD IsLoop:1;
    BITFIELD UseSpirit:1;
    BITFIELD ImmInsight:1;
};


class ENGINE_API UL2SceneItem : public UObject
{
public:
    FLOAT SceneTime;
    FStringNoInit Description;
    FCameraItem CameraInfo;
    FScreenItem ScreenInfo;
    FMusicItem MusicInfo;
    TArrayNoInit<FNpcItem> NpcInfo;
    TArrayNoInit<FPcItem> PcInfo;
    DECLARE_CLASS(UL2SceneItem,UObject,0,Engine)
    NO_DEFAULT_CONSTRUCTOR(UL2SceneItem)
};
...
public:
    ...
    INT SkinnedDataIndex GCC_PACK(4);
...
public:
    ...
    FMeshComponentArrayPtr MeshComponentArray[31];
    FMeshComponentArrayPtr MeshComponentBufferArray[31];
    BITFIELD bLoaded:1 GCC_PACK(4);
...
class ENGINE_API USimulationCylinderCollision : public USimulationCollision
{
public:
    FLOAT Radius;
    INT BoneIndexB;
    BITFIELD SphereA:1 GCC_PACK(4);
    BITFIELD SphereB:1;
    FVector BoneCenterB GCC_PACK(4);
    FVector AB;
    DECLARE_CLASS(USimulationCylinderCollision,USimulationCollision,0,Engine)
    NO_DEFAULT_CONSTRUCTOR(USimulationCylinderCollision)
};


class ENGINE_API USimulationSphereCollision : public USimulationCollision
{
public:
    FLOAT Radius;
    DECLARE_CLASS(USimulationSphereCollision,USimulationCollision,0,Engine)
    NO_DEFAULT_CONSTRUCTOR(USimulationSphereCollision)
};


class ENGINE_API USimulationData : public UObject
{
public:
    TArrayNoInit<INT> Anchors;
    TArrayNoInit<INT> WidthNodesCounts;
    TArrayNoInit<class USimulationSpringConstraint*> SpringConstraintData;
    TArrayNoInit<class USimulationCollision*> CollisionObjects;
    TArrayNoInit<BYTE> NeighbourState;
    TArrayNoInit<FVector> ForceSensitiveness;
    DECLARE_CLASS(USimulationData,UObject,0,Engine)
    NO_DEFAULT_CONSTRUCTOR(USimulationData)
};


class ENGINE_API USimulationNotify : public UObject
{
public:
    FLOAT frame;
    BITFIELD UseForce:1 GCC_PACK(4);
    FVector Force GCC_PACK(4);
    FLOAT ResetFactor;
    BITFIELD TerrainCollision:1 GCC_PACK(4);
    FLOAT TerrainCollisionZ GCC_PACK(4);
    FLOAT Stiffness;
    DECLARE_CLASS(USimulationNotify,UObject,0,Engine)
    NO_DEFAULT_CONSTRUCTOR(USimulationNotify)
};


class ENGINE_API USimulationSpringConstraint : public UObject
{
public:
    INT Responsiveness[8];
    INT NeighbourIndex[8];
    FLOAT DistAtRest[8];
    DECLARE_CLASS(USimulationSpringConstraint,UObject,0,Engine)
    NO_DEFAULT_CONSTRUCTOR(USimulationSpringConstraint)
};
...
AUTOGENERATE_FUNCTION(AActor,-1,execStopSound);
AUTOGENERATE_FUNCTION(AActor,-1,execPlayLoopSound);
...
AUTOGENERATE_FUNCTION(AShuttleDoor,-1,execClose);
AUTOGENERATE_FUNCTION(AShuttleDoor,-1,execOpen);
...
DECLARE_NATIVE_TYPE(Engine,AAirShip);
...
DECLARE_NATIVE_TYPE(Engine,UColorMask);
DECLARE_NATIVE_TYPE(Engine,URealtimeGenerationTexture);
DECLARE_NATIVE_TYPE(Engine,UColorWheel);
DECLARE_NATIVE_TYPE(Engine,UComplementModifier);
DECLARE_NATIVE_TYPE(Engine,ADynamicLight);
...
DECLARE_NATIVE_TYPE(Engine,UL2SceneInfo);
DECLARE_NATIVE_TYPE(Engine,UL2SceneItem);
...
DECLARE_NATIVE_TYPE(Engine,AServerBlockingVolume);
DECLARE_NATIVE_TYPE(Engine,AServerPrimitive);
DECLARE_NATIVE_TYPE(Engine,AShuttle);
DECLARE_NATIVE_TYPE(Engine,AShuttleDoor);
DECLARE_NATIVE_TYPE(Engine,AShuttleWall);
DECLARE_NATIVE_TYPE(Engine,USimulationCollision);
DECLARE_NATIVE_TYPE(Engine,USimulationCylinderCollision);
DECLARE_NATIVE_TYPE(Engine,USimulationData);
DECLARE_NATIVE_TYPE(Engine,USimulationNotify);
DECLARE_NATIVE_TYPE(Engine,USimulationSphereCollision);
DECLARE_NATIVE_TYPE(Engine,USimulationSpringConstraint);
...
DECLARE_NATIVE_TYPE(Engine,ASkyRenderInfo);
...
DECLARE_NATIVE_TYPE(Engine,AVehicleMeshPart);
DECLARE_NATIVE_TYPE(Engine,AVehicleRoutePoint);
DECLARE_NATIVE_TYPE(Engine,AVehicleServerPart);
...
#define AUTO_INITIALIZE_REGISTRANTS_ENGINE \
	...
	UColorMask::StaticClass(); \
	URealtimeGenerationTexture::StaticClass(); \
	UColorVariationMaterial::StaticClass(); \
	UColorWheel::StaticClass(); \
	UComplementModifier::StaticClass(); \
	ADynamicLight::StaticClass(); \
	...
	AL2RegionEffectInfo::StaticClass(); \
	UL2SceneInfo::StaticClass(); \
	UL2SceneItem::StaticClass(); \
	...
	AServerBlockingVolume::StaticClass(); \
	AServerPrimitive::StaticClass(); \
	AShuttle::StaticClass(); \
	AShuttleDoor::StaticClass(); \
	GNativeLookupFuncs[Lookup++] = &FindEngineAShuttleDoorNative; \
	AShuttleWall::StaticClass(); \
	USimulationCollision::StaticClass(); \
	USimulationCylinderCollision::StaticClass(); \
	USimulationData::StaticClass(); \
	USimulationNotify::StaticClass(); \
	USimulationSphereCollision::StaticClass(); \
	USimulationSpringConstraint::StaticClass(); \
	...
	AVehicleMeshPart::StaticClass(); \
	AVehicleRoutePoint::StaticClass(); \
	AVehicleServerPart::StaticClass(); \
...
{ 
	...
	MAP_NATIVE(AActor,execPlayLoopSound)
...
NATIVE_INFO(AShuttleDoor) GEngineAShuttleDoorNatives[] = 
{ 
	MAP_NATIVE(AShuttleDoor,execClose)
	MAP_NATIVE(AShuttleDoor,execOpen)
	{NULL,NULL}
};
IMPLEMENT_NATIVE_HANDLER(Engine,AShuttleDoor);
...
VERIFY_CLASS_SIZE_NODIE(UActionWarp)
VERIFY_CLASS_SIZE_NODIE(AAirEmitter)
VERIFY_CLASS_SIZE_NODIE(AAirShip)
VERIFY_CLASS_SIZE_NODIE(AAirVolume)
VERIFY_CLASS_SIZE_NODIE(AAmbientSound)
VERIFY_CLASS_SIZE_NODIE(UAmbientSoundObject)
VERIFY_CLASS_SIZE_NODIE(ULevelObject)
VERIFY_CLASS_SIZE_NODIE(UAnimNotify_AttackItem)
VERIFY_CLASS_SIZE_NODIE(UAnimNotify_AttackPreShot)
VERIFY_CLASS_SIZE_NODIE(UAnimNotify_AttackShot)
VERIFY_CLASS_SIZE_NODIE(UAnimNotify_AttackVoice)
VERIFY_CLASS_SIZE_NODIE(UAnimNotify_BoneScale)
VERIFY_CLASS_SIZE_NODIE(UAnimNotify_CameraLocation)
VERIFY_CLASS_SIZE_NODIE(UAnimNotify_Channeling)
VERIFY_CLASS_SIZE_NODIE(UAnimNotify_IdleSound)
VERIFY_CLASS_SIZE_NODIE(UAnimNotify_Illusion)
VERIFY_CLASS_SIZE_NODIE(UAnimNotify_ScreenFade)
VERIFY_CLASS_SIZE_NODIE(UAnimNotify_SwimSound)
VERIFY_CLASS_SIZE_NODIE(UAnimNotify_ViewShake)
VERIFY_CLASS_SIZE_NODIE(UColorMask)
VERIFY_CLASS_SIZE_NODIE(URealtimeGenerationTexture)
VERIFY_CLASS_SIZE_NODIE(UColorWheel)
VERIFY_CLASS_SIZE_NODIE(UComplementModifier)
VERIFY_CLASS_SIZE_NODIE(ADynamicLight)
VERIFY_CLASS_SIZE_NODIE(AEmitterLight)
VERIFY_CLASS_SIZE_NODIE(AEnvCreatureManagerInfo)
VERIFY_CLASS_SIZE_NODIE(UExtraMeshData)
VERIFY_CLASS_SIZE_NODIE(AInspector)
VERIFY_CLASS_SIZE_NODIE(AL2Alarm)
VERIFY_CLASS_SIZE_NODIE(AL2CenterdDiamond)
VERIFY_CLASS_SIZE_NODIE(UL2ColorModifier)
VERIFY_CLASS_SIZE_NODIE(AL2Dice)
VERIFY_CLASS_SIZE_NODIE(UL2EffectEmitter)
VERIFY_CLASS_SIZE_NODIE(AL2Float)
VERIFY_CLASS_SIZE_NODIE(AL2Indicator)
VERIFY_CLASS_SIZE_NODIE(AL2MovableStaticMeshActor)
VERIFY_CLASS_SIZE_NODIE(UL2NEnvLight)
VERIFY_CLASS_SIZE_NODIE(UL2NTimeLight)
VERIFY_CLASS_SIZE_NODIE(AL2NMover)
VERIFY_CLASS_SIZE_NODIE(AL2Pickup)
VERIFY_CLASS_SIZE_NODIE(AL2Radar)
VERIFY_CLASS_SIZE_NODIE(UL2SceneInfo)
VERIFY_CLASS_SIZE_NODIE(UL2SceneItem)
VERIFY_CLASS_SIZE_NODIE(AL2SeamlessInfo)
VERIFY_CLASS_SIZE_NODIE(UL2SkillEffect)
VERIFY_CLASS_SIZE_NODIE(ALineagePlayerController)
VERIFY_CLASS_SIZE_NODIE(ALocationInfo)
VERIFY_CLASS_SIZE_NODIE(AMarkProjector)
VERIFY_CLASS_SIZE_NODIE(UMaskTexture)
VERIFY_CLASS_SIZE_NODIE(UMeshComponent)
VERIFY_CLASS_SIZE_NODIE(UMeshContainer)
VERIFY_CLASS_SIZE_NODIE(AMovableStaticMeshActor)
VERIFY_CLASS_SIZE_NODIE(AMusicVolume)
VERIFY_CLASS_SIZE_NODIE(ANAgathion)
VERIFY_CLASS_SIZE_NODIE(ANCubics)
VERIFY_CLASS_SIZE_NODIE(ANMoon)
VERIFY_CLASS_SIZE_NODIE(ANMovableSunLight)
VERIFY_CLASS_SIZE_NODIE(ANpcPosInfo)
VERIFY_CLASS_SIZE_NODIE(ANProjectile)
VERIFY_CLASS_SIZE_NODIE(ANSkillProjectile)
VERIFY_CLASS_SIZE_NODIE(ANSun)
VERIFY_CLASS_SIZE_NODIE(URibbonEmitter)
VERIFY_CLASS_SIZE_NODIE(AServerBlockingVolume)
VERIFY_CLASS_SIZE_NODIE(AServerPrimitive)
VERIFY_CLASS_SIZE_NODIE(AShuttle)
VERIFY_CLASS_SIZE_NODIE(AShuttleDoor)
VERIFY_CLASS_SIZE_NODIE(AShuttleWall)
VERIFY_CLASS_SIZE_NODIE(USimulationCollision)
VERIFY_CLASS_SIZE_NODIE(USimulationCylinderCollision)
VERIFY_CLASS_SIZE_NODIE(USimulationData)
VERIFY_CLASS_SIZE_NODIE(USimulationNotify)
VERIFY_CLASS_SIZE_NODIE(USimulationSphereCollision)
VERIFY_CLASS_SIZE_NODIE(USimulationSpringConstraint)
VERIFY_CLASS_SIZE_NODIE(USkillAction)
VERIFY_CLASS_SIZE_NODIE(USkillAction_LocateEffect)
VERIFY_CLASS_SIZE_NODIE(USkillAction_SwordTrail)
VERIFY_CLASS_SIZE_NODIE(USkillVisualEffect)
VERIFY_CLASS_SIZE_NODIE(ASkyMeshActor)
VERIFY_CLASS_SIZE_NODIE(ASkyRenderInfo)
VERIFY_CLASS_SIZE_NODIE(ASpawnableStaticMeshActor)
VERIFY_CLASS_SIZE_NODIE(AStatLog)
VERIFY_CLASS_SIZE_NODIE(AStatLogFile)
VERIFY_CLASS_SIZE_NODIE(ASuperPointInfo)
VERIFY_CLASS_SIZE_NODIE(ATerritoryInfo)
VERIFY_CLASS_SIZE_NODIE(AVehicleMeshPart)
VERIFY_CLASS_SIZE_NODIE(AVehicleRoutePoint)
VERIFY_CLASS_SIZE_NODIE(AVehicleServerPart)
VERIFY_CLASS_SIZE_NODIE(AViewportWindowController)
VERIFY_CLASS_SIZE_NODIE(AWaterHitEmitter)
